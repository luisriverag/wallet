...
class MasterseedPasswordDialog : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // show/hide password
        binding?.cbShowPassword?.setOnCheckedChangeListener { compoundButton, b ->
            binding?.etPassphrase?.let { etPassword ->
                etPassword.inputType = InputType.TYPE_CLASS_TEXT or (if (b) InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD else InputType.TYPE_TEXT_VARIATION_PASSWORD)
